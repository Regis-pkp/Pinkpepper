...
if ( $meta_box[ 'type' ]=="text") { 
    ...
    <?php }  elseif($meta_box[ 'array']=="productcats") { ?>
    ...
    <?php } elseif($meta_box[ 'array']=="producttags") { ?>
...
<?php if($meta_box[ 'opentag' ]) {echo $meta_box[ 'opentag' ];} ?>
    <div class="page-options <?php if($meta_box[ 'size' ]) { echo $meta_box[ 'size' ]; } ?>">
		...
		<?php 
                ...
                <option <?php if($data[ $meta_box[ 'name' ] ]=="customplus") {?> selected="selected" <?php } ?> value="customplus">Custom Skin +</option>         
		...
		<?php 
                ...
                <option value="blackwhite" <?php if($data[ $meta_box[ 'name' ] ]=="blackwhite") { ?> selected="selected" <?php } ?>>Black &amp; White</option>
