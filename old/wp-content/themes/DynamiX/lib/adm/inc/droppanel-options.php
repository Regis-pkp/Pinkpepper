...
<tr valign="top">
	<td class="tr-top" style="width:160px">
    	<strong class="tooltip-next">Branding / Menu Position</strong><br class="clear large" />
    	<label for="branding_menu">Option One</label> 
    	<input type="radio" name="branding_menu" <?php if(get_option('branding_menu')=="one" || get_option('branding_menu')=="" ) {?> checked="checked" <?php } ?>  value="one" /> <br /> <small>Branding Left / Menu Right</small>
	</td>
    <td class="tr-top">
    	<br class="clear large" />
		<label for="branding_menu">Option Two</label> 
    	<input type="radio" name="branding_menu" <?php if(get_option('branding_menu')=="two") {?> checked="checked" <?php } ?>  value="two" /><br /> <small>Branding Right / Menu Left</small>
	</td>
</tr>
<tr valign="top">
    <td class="tr-top" colspan="2">
        <strong class="tooltip-next">Branding Settings</strong><br class="clear large" />
		<label for="branding_margin">Branding Top Margin</label>
    	<input type="text" name="branding_margin" style="width:30px" value="<?php echo get_option('branding_margin'); ?>" /> <small class="description">px</small>  <small style="padding-left:20px" class="description">(default is 40)</small>   
    </td>
</tr>
</table>
