...
$productcats =  array(
"opentag" => "<div style=\"float:left;margin-right:35px;\"><strong>Select Product Categories</strong><br />",
"type" => "chkbox",
"array" => 'productcats',
"id" => "productcat",
"name" => "productcat",
...
$producttags = array(
"opentag" => "<div style=\"float:left;margin-right:35px;\"><strong>Select Product Tags</strong><br />",
"type" => "chkbox",
"array" => 'producttags',
"id" => "producttag",
"name" => "producttag",
...
"outskin" => array(
"opentag" => '<div class="revealbox overflow"><h4 class="revealmeta"><span class="ui-icon"></span>Page Skins</h4><div class="reveal-content"><br />',
"type" => "menu",
"id" => "outskin",
"name" => "outskin",
...
"posttitle" => array(
"opentag" => '<div class="revealbox overflow"><h4 class="revealmeta"><span class="ui-icon"></span>Post Titles</h4><div class="reveal-content"><br />',
"type" => "field",
"name" => "posttitle",
"title" => "Post Title",
...
"size" => "large",
"description" => "Publish Author Name",
"closetag" => '<div class="clear"></div></div></div>')
...
"gallerycat" => array(
"opentag" => '<div class="clear"></div><div class="revealbox"><h4 class="revealmeta"><span class="ui-icon"></span>Gallery Data Source</h4><div class="reveal-content"><div style="margin-top:10px;line-height:35px;padding:5px 15px;" class="divborder galcats"><div style="width:200px;float:left"><strong>Select Post Categories</strong><br />',
"type" => 'chkbox',
"array" => 'cats',
"id" => 'gallerycat',
"name" => 'gallerycat',
