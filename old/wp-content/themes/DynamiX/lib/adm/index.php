	...
	toggle_shrtcode('linkbutton','dynshortcode_button_type');		
       ...
       <div id="postgallery">
         ...
         <table class="form-table">   
            ...
            <tr valign="top">
                ...
                <table width="100%" class="form-table">
                  <tr>
                    <td>
                    <label for="dynshortcode_postcat"><strong><?php _e('Select Post Categories:')?></strong></label><br />
					<?php
                    ...
                    <td><label for="dynshortcode_postcat"><strong><?php _e('Select Product Categories:')?></strong></label><br />
					<?php 
                    ...
                    <td><label for="dynshortcode_postcat"><strong><?php _e('Select Product Tags:')?></strong></label><br />
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_imagelightbox"><?php _e('Enable Lightbox:')?></label></td>
                <td>
            ...
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_imageeffectlinkurl"><?php _e('Link URL:')?></label></td>
                <td >
		...
		<div id="dropcaps"> 
        <small class="description">Select type and color.</small>   
        <table class="form-table">
            <tr valign="top">
        ...
        <table class="form-table">
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_content"><?php _e('Content:')?></label></td>
                <td colspan="3">
            ...
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_cats"><?php _e('Select Post Categories:')?></label>			</td>
                <td colspan="3">
						<?php
                    $categories=  get_categories(); 
                    foreach ($categories as $cat) {
            ...
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_imgwidth"><?php _e('Image Width:')?></label></td>
                <td >
					<input type="text" style="width:50px;" name="dynshortcode[recentposts_imgwidth]" id="dynshortcode_recentposts_limit" />
                </td>
                <td width="80px" ><label for="dynshortcode_recentposts_imgheight"><?php _e('Image Height:')?></label></td>
                <td >
					<input type="text" style="width:50px;" name="dynshortcode[recentposts_imgheight]" id="dynshortcode_recentposts_offset" />
                </td>
            </tr>               
			<tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_imageeffect"><?php _e('Image Effect')?></label></td>
                <td >
                ...
                <td width="80px" ><label for="dynshortcode_recentposts_shadowsize"><?php _e('Shadow Size')?></label></td>
                <td >
                 	<select name="dynshortcode[recentposts_shadowsize]" id="dynshortcode_recentposts_shadowsize">
                        <option value="shadow-xsmall">XSmall (100px)</option>
                        <option value="shadow-small">Small (230px)</option>
						<option value="shadow-medium">Medium (320px)</option>
						<option value="shadow-large">Large (920px)</option>                                             
            ...
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_imgalign"><?php _e('Image Align:')?></label></td>
                <td colspan="3">
            ...
            <tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_limit"><?php _e('Posts Limit:')?></label></td>
                <td >
					<input type="text" style="width:50px;" name="dynshortcode[recentposts_limit]" id="dynshortcode_recentposts_limit" />
                </td>
                <td width="80px" ><label for="dynshortcode_recentposts_offset"><?php _e('Posts Offset:')?></label></td>
                <td >
					<input type="text" style="width:50px;" name="dynshortcode[recentposts_offset]" id="dynshortcode_recentposts_offset" />
                </td>
            </tr>         		              
             <tr valign="top">
                <td width="80px" ><label for="dynshortcode_recentposts_sortby"><?php _e('Post Sort By')?></label></td>
                <td>
                ...
                <td width="80px" ><label for="dynshortcode_recentposts_orderby"><?php _e('Post Order By')?></label></td>
                <td >
            ...
            <tr valign="top">
               <td width="80px" ><label for="dynshortcode_recentposts_excerpt"><?php _e('Excerpt Word Limit:')?></label></td>
                <td>
                ...
                <td width="80px" ><label for="dynshortcode_recentposts_meta"><?php _e('Show Metadata:')?></label></td>
                <td>
...
function cwz_create_menu() {
	...
	add_submenu_page( 'main', 'Skin Settings', 'Skin Settings', 'administrator', 'skin_settings', 'load_skin');
...
//  GENERAL OPTIONS 
	...
	// Skin Select
	register_setting( 'skin-settings-group', 'outskin' );
	register_setting( 'skin-settings-group', 'inskin' );	
	
	// Skin Font Settings
	register_setting( 'skin-settings-group', 'skin_font_size' );
	register_setting( 'skin-settings-group', 'skin_font' );
	
	// General Font Color.
	register_setting( 'skin-settings-group', 'font_color' );

	// General Link Color.
	register_setting( 'skin-settings-group', 'font_link' );

	// General Link Hover Color.
	register_setting( 'skin-settings-group', 'font_hover' );
	
	// Sidebar Link Color.
	register_setting( 'skin-settings-group', 'side_link' );

	// Sidebar Link Hover Color.
	register_setting( 'skin-settings-group', 'side_hover' );
	
	// Enable Cufon.
	register_setting( 'skin-settings-group', 'cufon_enable' );
	
	// Effect HTML tags.
	register_setting( 'skin-settings-group', 'cufon_tags' );
	
	// Cufon JS font file.
	register_setting( 'skin-settings-group', 'cufon_font' );

	// Custom CSS.
	register_setting( 'skin-settings-group', 'custom_css' );	
	
	// Primary Cufon Gradient.
	register_setting( 'skin-settings-group', 'cufongradpri_1' );
	register_setting( 'skin-settings-group', 'cufongradpri_2' );
	register_setting( 'skin-settings-group', 'cufongradpri_3' );
	register_setting( 'skin-settings-group', 'cufongradpri_4' );
	register_setting( 'skin-settings-group', 'cufongradpri_5' );	
	register_setting( 'skin-settings-group', 'cufongradpri_6' );
		
	// Secondary Cufon Gradient.
	register_setting( 'skin-settings-group', 'cufongradsec_1' );
	register_setting( 'skin-settings-group', 'cufongradsec_2' );
	register_setting( 'skin-settings-group', 'cufongradsec_3' );
	register_setting( 'skin-settings-group', 'cufongradsec_4' );
	register_setting( 'skin-settings-group', 'cufongradsec_5' );	
	register_setting( 'skin-settings-group', 'cufongradsec_6' );
	
	register_setting( 'skin-settings-group', 'skin_header_image' );
	register_setting( 'skin-settings-group', 'skin_header_image_valign' );
	register_setting( 'skin-settings-group', 'skin_header_image_halign' );
	register_setting( 'skin-settings-group', 'skin_header_image_repeat' );
	register_setting( 'skin-settings-group', 'skin_header_pri_color' );
	register_setting( 'skin-settings-group', 'skin_header_sec_color' );

	register_setting( 'skin-settings-group', 'skin_headergallery_image' );
	register_setting( 'skin-settings-group', 'skin_headergallery_image_valign' );
	register_setting( 'skin-settings-group', 'skin_headergallery_image_halign' );
	register_setting( 'skin-settings-group', 'skin_headergallery_image_repeat' );
	register_setting( 'skin-settings-group', 'skin_headergallery_pri_color' );
	register_setting( 'skin-settings-group', 'skin_headergallery_sec_color' );

	register_setting( 'skin-settings-group', 'skin_footer_image' );
	register_setting( 'skin-settings-group', 'skin_footer_image_valign' );
	register_setting( 'skin-settings-group', 'skin_footer_image_halign' );
	register_setting( 'skin-settings-group', 'skin_footer_image_repeat' );
	register_setting( 'skin-settings-group', 'skin_footer_pri_color' );
	register_setting( 'skin-settings-group', 'skin_footer_sec_color' );
	
	register_setting( 'skin-settings-group', 'skin_menu_link_color' );
	register_setting( 'skin-settings-group', 'skin_menu_linkhover_color' );
	register_setting( 'skin-settings-group', 'skin_menu_text_color' );
	register_setting( 'skin-settings-group', 'skin_menu_back_color' );
	register_setting( 'skin-settings-group', 'skin_menu_border_color' );

	register_setting( 'skin-settings-group', 'skin_footer_link_color' );
	register_setting( 'skin-settings-group', 'skin_footer_linkhover_color' );
	register_setting( 'skin-settings-group', 'skin_footer_text_color' );
	register_setting( 'skin-settings-group', 'skin_footer_back_color' );
	register_setting( 'skin-settings-group', 'skin_footer_border_tl_color' );
	register_setting( 'skin-settings-group', 'skin_footer_border_br_color' );


	// WP Custom Menu for Main Menu.
	register_setting( 'general-settings-group', 'wpcustomm_enable' );
	register_setting( 'general-settings-group', 'wpcustommdesc_enable' );
...
//	BLOG OPTIONS 
	...
	// Show Author Bio
	register_setting( 'blog-settings-group', 'author_bio' );
...
//  DROP PANEL OPTIONS 
	...
	register_setting( 'droppanel-settings-group', 'branding_menu');
...
if($_REQUEST['page']=="skin_settings") {
...
function load_skin() {
	require CWZ_FILES .'/adm/inc/skin-settings.php';
}
