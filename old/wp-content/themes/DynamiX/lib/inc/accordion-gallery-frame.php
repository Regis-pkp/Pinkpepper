...
?>
<li class="<?php echo $DYN_cssclasses; ?> <?php if($DYN_imageeffect=='shadowblackwhite' || $DYN_imageeffect=='blackwhite') echo 'blackwhite' ?>">
...
<?php } elseif($DYN_groupgridcontent!="image" && $DYN_slidesetid!="") { ?>  
		...
		<div class="excerpt">
			...
			if(!$DYN_disablegallink && !$DYN_disablereadmore) { ?>
			<br /><br /><a href="<?php if($DYN_galexturl) { echo $DYN_galexturl; } ?>"><?php _e( 'Lire plus &rarr;', 'DynamiX' );  ?></a>
			<?php }			
