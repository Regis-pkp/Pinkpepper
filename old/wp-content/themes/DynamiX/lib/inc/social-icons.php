...
<li class="social-rss"><a href="<?php echo get_permalink(); ?>feed/" title="RSS" target="_blank"><img src="<?php bloginfo("template_url"); ?>/images/blank.gif" width="21" height="21" alt="RSS" /></a></li><?php } ?>  
</ul>
</div><!-- /socialicons -->
<div class="clear"></div>