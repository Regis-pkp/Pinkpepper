...
$categories = str_replace("'", '', $categories); // strip quotes
...
if($DYN_imageeffect=='shadowblackwhite') { $DYN_imageeffect = 'shadow'; $NV_blackwhite='blackwhite'; } // add space for separate effects (shadow / black white)
    ...
    <?php } elseif($DYN_previewimgurl) { ?>    
		...
		<div class="container <?php echo $DYN_shadowsize.' '.$DYN_imageeffect.' '.$DYN_cssclasses; ?>">
			<div class="gridimg-wrap">
            	<div class="title-wrap <?php echo $NV_blackwhite; ?>" style="width:<?php echo $DYN_imgwidth; ?>px">	
				...
				<img <?php if($DYN_imageeffect=="reflection" || $DYN_imageeffect=="shadowreflection") { ?>class="reflect"<?php } ?> src="<?php echo $DYN_imagepath . dyn_getimagepath($DYN_previewimgurl); ?>" alt="<?php if($DYN_slidesetid) { echo $DYN_posttitle; } else { the_title(); } ?>" <?php if( !empty($DYN_imgwidth) ) { ?> width="<?php echo $DYN_imgwidth; ?>" <?php } ?> height="<?php echo $DYN_imgheight; ?>" />
