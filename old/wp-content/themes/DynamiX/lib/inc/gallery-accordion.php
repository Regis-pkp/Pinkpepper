...
<div id="cwz-accordion" class="accordion-gallery-wrap <?php if($DYN_imageeffect=="shadow" || $DYN_imageeffect=="shadowblackwhite") { ?>shadow<?php } elseif($DYN_imageeffect=="reflection") { ?>reflection<?php } elseif($DYN_imageeffect=="shadowreflection") { ?>shadowreflection<?php } ?> stage">
