<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	if(!$DYN_authorname && get_option('author_bio')=='enable') $DYN_authorname='enable'; elseif(get_option('author_bio')=='posts') $DYN_authorname = 'posts'; else $DYN_authorname=''; 
	...
	if(isset($data["productcat"])) {$DYN_productcat=$data["productcat"];}
	
	if(isset($data["producttag"])) {$DYN_producttag=$data["producttag"];}
