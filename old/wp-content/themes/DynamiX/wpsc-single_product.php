			...
			<div class="single_product_display product_view_<?php echo wpsc_the_product_id(); ?>">
						...
						<?php if(wpsc_the_product_thumbnail()) :?>
                    		<div class="container <?php echo $image_effect; ?> <?php if($shadow_size) echo $shadow_size; ?>">
								<div class="gridimg-wrap">
                                 <a <?php if(get_option('show_thumbnails_thickbox')=="1") : ?>  rel="prettyPhoto[<?php echo str_replace(array(" ", '"',"'", '&quot;','&#039;'), array("_", "", "", "",''), wpsc_the_product_title()); ?>]" <?php endif; ?> class="<?php if(get_option('show_thumbnails_thickbox')=="1") : ?> galleryimg <?php endif; ?>preview_link" href="<?php echo wpsc_the_product_image(); ?>" style="height:<?php echo $image_height; ?>px">
									<img class="product_image <?php echo $image_reflect; ?>" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_image($image_width, $image_height); ?>" width="<?php echo get_option('single_view_image_width'); ?>" height="<?php echo get_option('single_view_image_height'); ?>" />
								</a>
                                </div>
							</div>
						<?php else: ?> 
				...
				<div class="textcol" <?php if(get_option('show_thumbnails')) { ?>style="margin-left:<?php echo $image_width+15; ?>px"<?php } ?>>
					<div class="producttext">
						<h2 class="prodtitles"><span><?php echo wpsc_the_product_title(); ?></span></h2>
							<?php				
