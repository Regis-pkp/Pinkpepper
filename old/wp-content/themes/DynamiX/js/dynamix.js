			...
			this.init = function(options)
			{
				...
				if(supportsCanvas &&(!(jQuery.browser.msie && jQuery.browser.version == '9.0')))
				{
					...
					$(container).each(function(index,currImageWrapper){
						...
						//adding the canvas
						$('<canvas class="bwcanvas" width="'+currWidth+'" height="'+currHeight+'"></canvas>').prependTo(currImageWrapper);
						//getting the canvas
					...
					if(hoverEffect)
					{
						...
						{
							$(this).find('canvas:first').stop(true,true).fadeOut();
						});
						$(container).mouseleave(function()
						{
							$(this).find('canvas:first').stop(true,true).fadeIn();
						});
					}
				} else 
				{
...
$(document).ready(function() {
	...
	$('#dropmenu li,#dyndropmenu li,.main-nav li').not('#nv-tabs ul li.extended-menu ul li').hover(function(e) {
